...
abstract class _$$CreateAccountEventImplCopyWith<$Res> {
  factory _$$CreateAccountEventImplCopyWith(
    _$CreateAccountEventImpl value,
...
class __$$CreateAccountEventImplCopyWithImpl<$Res>
  ...
  __$$CreateAccountEventImplCopyWithImpl(
    _$CreateAccountEventImpl _value,
...
class _$CreateAccountEventImpl implements CreateAccountEvent {
  const _$CreateAccountEventImpl({required this.email, required this.password});
  ...
  @override
  String toString() {
    return 'AuthEvent.createAccount(email: $email, password: $password)';
  }
